...
SECRET_KEY = '88mp8aj__!(0bglg0746yr6gi-2cibn1deoj+=0j)v#ph%=k6l'
...
INSTALLED_APPS = [
    ...
    'rest_framework',   #   用rest_framework需要注册
...
MIDDLEWARE = [
    ...
    'app01.utils.cors.CORSMiddleware',
]
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://127.0.0.1",        # 配置自己的ip
        "OPTIONS": {
