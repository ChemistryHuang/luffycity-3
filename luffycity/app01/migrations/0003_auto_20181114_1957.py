# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-11-14 11:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='course',
            options={'verbose_name_plural': '05.学位课奖学金'},
        ),
        migrations.AlterField(
            model_name='coursedetail',
            name='teachers',
            field=models.ManyToManyField(related_name='teacher', to='app01.Teacher', verbose_name='课程讲师'),
        ),
        migrations.AddField(
            model_name='couponrecord',
            name='account',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.Account', verbose_name='拥有者'),
        ),
        migrations.AddField(
            model_name='couponrecord',
            name='coupon',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.Coupon'),
        ),
    ]
