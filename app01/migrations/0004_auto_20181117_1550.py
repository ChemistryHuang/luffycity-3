# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-11-17 07:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='account',
            name='uid',
            field=models.CharField(help_text='微信用户绑定和CC视频统计', max_length=64, null=True, unique=True),
        ),
        ...
        migrations.AddField(
            ...
            name='account',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.Account'),
        ),
        migrations.AddField(
            model_name='transactionrecord',
            name='content_type',
        ...
        migrations.AddField(
            ...
            name='mentor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mentor', to='app01.Account', verbose_name='导师'),
        ),
        ...
        migrations.AddField(
            ...
            name='account',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.Account', verbose_name='被执行人'),
        ),
        migrations.AddField(
            model_name='scorerecord',
            name='content_type',
        ...
        migrations.AddField(
            model_name='scorerecord',
            name='degree_course',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app01.DegreeCourse', verbose_name='关联学位课程'),
        ),
        migrations.AddField(
            model_name='scorerecord',
            name='score_rule',
        ...
        migrations.AddField(
            ...
            name='mentor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='my_stu_homework_record', to='app01.Account', verbose_name='导师'),
        ),
        migrations.AddField(
            model_name='homeworkrecord',
            name='student',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.EnrolledDegreeCourse', verbose_name='学生'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='enrolleddegreecourse',
            name='degree_course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.DegreeCourse'),
        ),
        migrations.AddField(
            model_name='enrolleddegreecourse',
            name='mentor',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='my_students', to='app01.Account', verbose_name='导师'),
        ),
        migrations.AddField(
            model_name='enrolleddegreecourse',
            name='order_detail',
